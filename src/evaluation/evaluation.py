...
if __name__ == "__main__":
    model_names = [model_name for model_name in os.listdir("models") if re.search(r"v2", model_name)]
    labels = []
    preds = []
    for model_name in model_names:
        ...
        data, data_labels = load_data(testing_data_path=os.path.join("data", f"frames_{window_size}_S2_sm1_normBVP_without_meditation", "testing.h5"))
